...
export default function Register(){
    return(
      ...
      <button  className="mt-4 bg-blue-500 text-white border rounded-lg p-2 mt-2 " type='submit' value='Register'>kayıt ol</button>
<span>zaten hesabın var mı? <a className="text-blue-500 underline" href="/login">giriş yap</a></span>
    </form>
        </Layout>
    )
}